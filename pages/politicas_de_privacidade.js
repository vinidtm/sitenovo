...
function Politica_de_Privacidade () {
    ...
    <link rel='shortcut icon' href='/Icon.jpg' />
       ...
       <div class="container-privacidade-termos">
        ...
        <h2>Política de Cookies Elixir Bioativo</h2>
      ...
      <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Elixir Bioativo oferece no site e com caráter enunciativo, mas não limitativo:</p>
      ...
      <p>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Elixir Bioativo, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</p>
