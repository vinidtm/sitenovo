  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://saudeperfeitahoje.online/promocaocl"/>
          ...
          <div id="division-RkYytd8853835" className="QvBtcQ5665127">
            <div className="headline-cgoCmJ8850752">
              <div className="headline-cgoCmJ8850752-element headline">
                <h1>
                  VOCÊ ACABOU DE&nbsp;
                  <span style={{ backgroundColor: '#22ff00' }}>GANHAR R$30,00</span>!
                </h1>
              </div>
            </div>
            <div>
                <p>
                  Gostaria de receber um&nbsp;<u>desconto imperdível</u>&nbsp;para ter acesso ao&nbsp;
                  <span style={{ color: '#ff0000' }}><b>Guia Eliminando Celulite</b></span>&nbsp;e descobrir as receitas secretas capazes de fazer você eliminar qualquer celulite que você tanto sonha em perder?
                </p>
            </div>
            <div>
                <p>
                  ...
                  Você foi uma das mulheres&nbsp;<b>SELECIONADAS</b>&nbsp;para ter acesso ao&nbsp;
                  <span style={{ color: '#ff0000' }}><b>Guia Eliminando Celulite</b></span>&nbsp;com uma oportunidade única e exclusiva!<br /><br />
                  ...
                  Você tem a oportunidade agora mesmo de&nbsp;<b>finalmente eliminar a celulite</b>...
                </p>
            </div>
            <div>
                <p>
                  <b>Antes por&nbsp;<span style={{ color: '#ff0000' }}><del>R$ 97,00</del></span>, agora por apenas&nbsp;<span style={{ backgroundColor: '#ffff00' }}>R$ 67,00</span></b><br /><br />
                  <b>30% DE DESCONTO (<span style={{ backgroundColor: '#ffff00' }}>-R$30.00</span>)</b>&nbsp;para você ter acesso ao&nbsp;
                  <span style={{ color: '#ff0000' }}><b>Guia Eliminando Celulite</b></span>!!
                </p>
            </div>
            <div>
                <p>
            ...
            <div className="button-BcKPHv6494987">
              <a href="https://pay.kiwify.com.br/ljXYbX4" target="_self" className="btn button-BcKPHv6494987-element zooming">
            ...
            <div>
                <p>
                  ...
                  <span style={{ fontStyle: 'italic' }}>...que o seu corpo estivesse lisinho e sem nenhuma celulite...</span><br /><br />
                  <span style={{ fontStyle: 'italic' }}>...que as pessoas ao seu redor te elogiassem pela sua beleza e pelo seu corpo perfeito?</span><br /><br />
                  <b>ENTÃO...</b><br /><br />
                  O&nbsp;<span style={{ color: '#ff0000' }}><b>Guia Eliminando Celulite</b></span>&nbsp;é para você,&nbsp;<b>MULHER</b>...<br /><br />
                  Um programa criado por uma das maiores&nbsp;<b>doutoras</b>&nbsp;especializadas em celulites do mundo, onde você vai descobrir as receitas caseiras secretas feitas com&nbsp;
                  <span style={{ color: '#ff0000' }}><b>INGREDIENTES NATURAIS</b></span>..<br /><br />
                  A única capaz de fazer você&nbsp;<u><b>elimnar as celulites de forma natural</b></u>...<br /><br />
                  E se tornar uma mulher mais&nbsp;<u><b>autoconfiante, bonita e feliz</b></u>...<br /><br />
                  <b>A DECISÃO ESTÁ NAS SUAS MÃOS!</b>&nbsp;<br /><br />
                  Decisão que pode salvá-la da terrível celulite que está assolando a sua geração...<br /><br />
                  Basta CLICAR NO BOTÃO ABAIXO agora mesmo e seja bem-vinda ao&nbsp;
                  <span style={{ color: '#ff0000' }}><b>Guia Eliminando Celulite</b></span>
                </p>
            </div>
            <div className="button-BcKPHv6494987">
              <a href="https://pay.kiwify.com.br/ljXYbX4" target="_self" className="btn button-BcKPHv6494987-element zooming">
               ...
               <div>
                <p>
                  ...
                  Se o programa não gerar resultados rápidos e efetivos na sua vida, ou se, por qualquer motivo, você não gostar do&nbsp;
                  <span style={{ color: '#ff0000' }}><b>Guia Eliminando Celulite</b></span>...<br /><br />
                  ...
                  Aproveite nosso desconto especial de&nbsp;<span style={{ color: '#ff0000' }}><del>R$97,00</del></span>… agora por apenas&nbsp;<span style={{ backgroundColor: '#ffff00' }}><b>R$ 67,00</b></span><br />
                </p>
            </div>
            <div className="button-BcKPHv6494987">
              <a href="https://pay.kiwify.com.br/ljXYbX4" target="_self" className="btn button-BcKPHv6494987-element zooming">
            ...
            <div>
                <p>
                  ...
                  <span style={{ backgroundColor: '#ffff00' }}><b>Passo 3</b></span>: Acesse o Guia Eliminando Celulite e transforme a sua vida<br /><br />
                  <span style={{ fontStyle: 'italic' }}>Atenciosamente, Equipe Eliminando Celulite...</span><br />
                </p>
              </div>
        </div>
        </div>
